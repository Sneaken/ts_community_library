// export const LOGIN_URL: string = 'http://127.0.0.1:7001/api/user/login';
export const LOGIN_URL: string = '/api/user/login';
// export const VERIFY: string = 'http://127.0.0.1:7001/api/verify';
export const VERIFY: string = '/api/verify';
